    ...
    return (
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-44 rounded-xl border border-slate-200/80 bg-white p-5 animate-pulse space-y-3">
              <div className="h-4 w-36 bg-slate-200 rounded-md" />
              <div className="h-3.5 w-48 bg-slate-100 rounded-md" />
              <div className="h-8 w-full bg-slate-50 rounded-lg mt-4" />
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="rounded-xl border border-rose-200 bg-white p-8 text-center shadow-xs space-y-4">
          ...
          <div className="flex items-center justify-center gap-3 pt-2">
            ...
            >
              ...
              <span>Create Profile Directly</span>
            </Link>
          </div>
        </div>
      </div>
